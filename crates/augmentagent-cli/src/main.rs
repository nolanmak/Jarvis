...
fn configure_newsletter_tools(
    ...
    for op in ["create", "brief", "research", "run", "cancel", "evidence", "feedback", "feedback-list", "rank", "schedule-create", "schedule-list", "schedule-get", "schedule-edit", "schedule-run", "generate", "draft"] {
