...
fn configure_newsletter_tools(
    ...
    for op in ["create", "brief", "research", "run", "cancel", "browser-task", "browser-tasks", "browser-task-get", "browser-task-cancel", "evidence", "feedback", "feedback-list", "rank", "rank-reset", "schedule-create", "schedule-list", "schedule-get", "schedule-edit", "schedule-run", "generate", "draft"] {
