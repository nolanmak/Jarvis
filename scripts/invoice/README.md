...
| `INVOICE_FROM_ENTITY` | Composio entity/user_id for the sending Gmail (operator-alt@example.com) |
...
python3 send_invoice.py --number 35 --start 2026-05-17 --end 2026-05-24 \
    --to operator-alt@example.com --from-entity <entity>

# real send
python3 send_invoice.py --number 35 --start 2026-05-17 --end 2026-05-24 \
    --to operator-alt@example.com --from-entity <entity> --dry-run false
```
