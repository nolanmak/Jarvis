...
FROM_LINES = ["Meraki Mind", "Nolan Makatche", "167 Cheyney Rd",
              "Glen Mills, PA 19342", "610-306-3535"]
BILL_TO = "Glass Entertainment Group"
...
DEFAULT_GH_REPO = os.environ.get("ORCHID_GH_REPO", "OrchidStudio/orchid")
