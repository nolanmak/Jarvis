#!/usr/bin/env python3
"""Install/uninstall the optional macOS Messages export schedule."""
import argparse
import os
...
def make_plist(sync_args, interval, home=None):
    ...
    log = home / "Library/Logs/augmentagent/imessage-sync.log"
    return {
        "Label": LABEL,
...
def main():
    ...
    print(f"Logs: {log_dir / 'imessage-sync.log'}")
